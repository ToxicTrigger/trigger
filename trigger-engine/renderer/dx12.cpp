...
void dx12::set_up()
{
	...
	ImGui_ImplWin32_Init(this->mhMainWnd);
...
void dx12::draw_dx12()
{
	...
	if(this->edit_mode)
	{
		...
		ImGui::GetWindowDrawList()->AddImage(
			(void *)g_mainRenderTargetDescriptor,
			ImVec2(ImGui::GetCursorScreenPos()), ImVec2(pos.x + 500, pos.y + 200),
			ImVec2(0, 1),
			ImVec2(1, 0));
		ImGui::End();
	}
